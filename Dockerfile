...
RUN apt-get update && \
    ...
    curl -o "docker-minecraft-craft-to-exile-2/Craft-to-Exile-2-Server-0.6.2.zip" -L https://github.com/manfromdownunder/docker-minecraft-craft-to-exile-2/releases/download/C2E2/Craft-to-Exile-2-Server-0.6.2.zip && \
    ...
    cp docker-minecraft-craft-to-exile-2/Craft-to-Exile-2-Server-0.6.2.zip /minecraft/server/Craft-to-Exile-2-Server-0.6.2.zip && \
    ...
    rm /minecraft/server/Craft-to-Exile-2-Server-0.6.2.zip && \
    rm /minecraft/docker-minecraft-craft-to-exile-2/Craft-to-Exile-2-Server-0.6.2.zip
